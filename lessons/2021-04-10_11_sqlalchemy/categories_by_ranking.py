"""
List the categories of all movies and their rankings, for the films that were produced between 2000 and 2010
and had rankings greater than 7, also, sort them by their ranking. Use select () and query ().
"""
